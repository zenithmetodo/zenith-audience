...
## Estructura de output que entrego

```markdown
# REEL · "[título]" · Formato [X]
...
- Cuando ya tienes guion completo
...
### Recibo input de
- `asuntos-generator` (la idea)
- `template-selector` / `template-aplicador` (template viral)
- `gatillo-master` (gatillos a aplicar)
